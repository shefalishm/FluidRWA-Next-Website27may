...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: MetadataRoute.Sitemap = [
    ...
    { url: `${siteUrl}/use-cases`, lastModified: "2026-09-22", changeFrequency: "weekly", priority: 0.92 },
    ...useCases.map((useCase) => ({
      url: `${siteUrl}/use-cases/${useCase.slug}`,
      lastModified: ["fiat-stablecoin-funding-redemption", "investor-wallet-onboarding-custody"].includes(useCase.slug) ? "2026-09-22" : "2026-09-16",
      changeFrequency: "monthly" as const,
      priority: 0.82
    })),
