...
const fallbackCategories: Record<string, VendorCategoryFallback> = {
  ...
  "vendors/security-audits/index.html": {
    slug: "security-audits",
    title: "Compare Security & Audit Vendors",
    intro:
      "Security firms and audit networks supporting smart contracts, protocols, wallets, infrastructure, formal verification, monitoring and Web3 risk management.",
    vendors: [
      {
        name: "Trail of Bits",
        type: "Security Research & Audits",
        url: "https://www.trailofbits.com",
        bestFor: "Protocols, institutions and infrastructure teams that need deep security research, cryptography review and high-assurance audits.",
        description:
          "Trail of Bits provides security engineering, smart contract audits, cryptography review, fuzzing, tooling and research for complex systems.",
        intelligence:
          "Best suited for high-risk systems where security depth, formal methods and engineering rigor matter more than speed or surface-level review.",
        tags: ["Security Research", "Cryptography", "Formal Methods", "Audits"],
        hq: "USA",
        founded: "2012",
        services: "Smart contract audits, cryptography, fuzzing, security research",
        markets: "Global"
      },
      {
        name: "OpenZeppelin",
        ...
        bestFor: "Web3 teams that need smart contract audits, secure libraries, monitoring and battle-tested security patterns.",
        description:
          "OpenZeppelin provides smart contract audits, security tooling and widely used Solidity libraries for blockchain applications.",
        intelligence:
          "A strong fit for teams building EVM contracts that want audit support from the creators of some of the most widely adopted smart contract standards.",
        tags: ["Solidity", "EVM", "Libraries", "Audits"],
        hq: "Global",
        founded: "2015",
        services: "Audits, smart contract libraries, monitoring, security advisory",
        markets: "Global"
      },
      {
        name: "CertiK",
        type: "Blockchain Security Platform",
        url: "https://www.certik.com",
        bestFor: "Projects that need smart contract audits, monitoring, KYC, bug bounty support and public-facing security visibility.",
        description:
          "CertiK provides blockchain security services including smart contract audits, Skynet monitoring, KYC and security rankings.",
        intelligence:
          "Useful for projects that need both technical review and public security signaling for exchanges, communities and ecosystem stakeholders.",
        tags: ["Audits", "Monitoring", "KYC", "Security Ratings"],
        hq: "USA",
        founded: "2018",
        services: "Audits, monitoring, KYC, bug bounty support",
        markets: "Global"
      },
      {
        name: "Quantstamp",
        type: "Smart Contract Audits",
        url: "https://quantstamp.com",
        bestFor: "DeFi, NFT, wallet and infrastructure teams seeking smart contract audits and protocol security reviews.",
        description:
          "Quantstamp provides smart contract audits, protocol reviews and blockchain security services for Web3 applications and infrastructure.",
        intelligence:
          "Appropriate for teams that want an established crypto audit firm with experience across DeFi, L1/L2 ecosystems and enterprise blockchain systems.",
        tags: ["Audits", "DeFi", "Protocol Review", "Enterprise"],
        hq: "USA / Canada",
        founded: "2017",
        services: "Smart contract audits, protocol security, consulting",
        markets: "Global"
      },
      {
        name: "Halborn",
        type: "Web3 Security & Penetration Testing",
        url: "https://halborn.com",
        bestFor: "Digital asset companies that need smart contract audits, application security, cloud security and penetration testing.",
        description:
          "Halborn provides cybersecurity services for blockchain companies, including smart contract audits, penetration testing and security consulting.",
        intelligence:
          "Useful for companies where the risk surface extends beyond smart contracts into applications, wallets, APIs, cloud infrastructure and operations.",
        tags: ["Pen Testing", "Audits", "Cloud Security", "Web3"],
        hq: "USA",
        founded: "2019",
        services: "Audits, penetration testing, app security, cloud security",
        markets: "Global"
      },
      {
        name: "Spearbit",
        type: "Security Review Network",
        url: "https://spearbit.com",
        bestFor: "Protocols that need expert-led security reviews from a distributed network of senior Web3 security researchers.",
        description:
          "Spearbit operates a network of security researchers focused on smart contract audits and protocol-level security reviews.",
        intelligence:
          "A strong option for complex DeFi and infrastructure systems that benefit from multiple specialist reviewers instead of a single fixed audit team.",
        tags: ["Research Network", "DeFi", "Protocol Audits", "Expert Review"],
        hq: "Global",
        founded: "2021",
        services: "Smart contract audits, protocol reviews, researcher network",
        markets: "Global"
      },
      {
        name: "Consensys Diligence",
        type: "Ethereum Security Audits",
        url: "https://consensys.io/diligence",
        bestFor: "Ethereum and EVM teams that need smart contract audits, formal verification and security tooling.",
        description:
          "Consensys Diligence provides smart contract audits, fuzzing, formal verification and security tools for Ethereum-based systems.",
        intelligence:
          "Best aligned with EVM projects that want security review from a team deeply embedded in the Ethereum developer ecosystem.",
        tags: ["Ethereum", "EVM", "Formal Verification", "Fuzzing"],
        hq: "USA / Global",
        founded: "2017",
        services: "Audits, fuzzing, formal verification, Ethereum security",
        markets: "Global"
      },
      {
        name: "Sherlock",
        type: "Audit Contests & Coverage",
        url: "https://www.sherlock.xyz",
        bestFor: "DeFi protocols that want competitive audits, bug discovery and optional coverage models around smart contract risk.",
        description:
          "Sherlock provides audit contests, security reviews and coverage-oriented security programs for smart contract protocols.",
        intelligence:
          "Useful for DeFi teams that want broad reviewer participation and bug-finding intensity through contest-based security workflows.",
        tags: ["Audit Contests", "DeFi", "Coverage", "Bug Discovery"],
        hq: "Global",
        founded: "2021",
        services: "Audit contests, security reviews, coverage",
        markets: "Global"
      },
      {
        name: "Code4rena",
        type: "Competitive Audit Marketplace",
        url: "https://code4rena.com",
        bestFor: "Protocols that want crowd-sourced security contests with many independent researchers reviewing the codebase.",
        description:
          "Code4rena runs competitive audit contests where security researchers find and report vulnerabilities in Web3 codebases.",
        intelligence:
          "Works well as part of a broader security program, especially when teams want many reviewers and transparent contest-based findings.",
        tags: ["Competitive Audits", "Research Community", "DeFi", "Bug Discovery"],
        hq: "Global",
        founded: "2021",
        services: "Audit contests, researcher marketplace, security reviews",
        markets: "Global"
      },
      {
        name: "Hacken",
        ...
        url: "https://hacken.io",
        bestFor: "Projects needing smart contract audits, penetration testing, bug bounties and security assessment services.",
        description:
          "Hacken provides blockchain cybersecurity services including smart contract audits, penetration testing, bug bounty programs and proof-of-reserves support.",
        intelligence:
          "Useful for Web3 companies that need a broader cybersecurity partner across contract security, exchange readiness and operational risk.",
        tags: ["Audits", "Pen Testing", "Bug Bounty", "PoR"],
        hq: "Estonia / Global",
        founded: "2017",
        services: "Audits, penetration testing, bug bounties, proof of reserves",
        markets: "Global"
      },
      {
        name: "Certora",
        ...
        bestFor: "DeFi protocols and critical smart contracts that need formal verification of business logic and security properties.",
        description:
          "Certora provides formal verification tools and services for proving smart contract correctness against defined rules and invariants.",
        intelligence:
          "Best for systems where economic invariants, lending logic, token mechanics or protocol accounting must be mathematically checked before launch.",
        tags: ["Formal Verification", "DeFi", "Invariants", "Protocol Safety"],
        hq: "USA / Israel",
        founded: "2018",
        services: "Formal verification, rule specification, protocol analysis",
        markets: "Global"
      },
      {
        name: "ChainSecurity",
        ...
        bestFor: "Protocols and enterprises that need smart contract audits, formal methods and high-assurance blockchain security review.",
        description:
          "ChainSecurity provides smart contract audits and formal verification-oriented security services for blockchain protocols and applications.",
        intelligence:
          "A fit for teams that need rigorous smart contract review with emphasis on correctness, protocol mechanics and technical assurance.",
        tags: ["Audits", "Formal Methods", "Protocol Review", "Smart Contracts"],
        hq: "Switzerland",
        founded: "2017",
        services: "Smart contract audits, formal methods, protocol security",
        markets: "Global"
      }
    ]
  }
