...
const guides = JSON.parse(fs.readFileSync(path.join(root, "scripts", "aug27-comparisons.json"), "utf8"));
...
for (const g of guides) {
  const faqs = [
    ...
    ["How current is this comparison?", "It was reviewed on August 27, 2026 using the linked primary vendor materials. Verify current availability directly before procurement."]
  ];
