...
function reportCard(report) {
  return `<a class="report-card" href="${esc(report.href)}" target="_blank" rel="noopener noreferrer"><span>${esc(report.label)}</span><h3>${esc(report.title)}</h3><strong>By ${esc(report.author)}</strong><time datetime="${esc(report.date)}">${esc(report.dateLabel)}</time><p>${esc(report.description)}</p><b>Access Report</b></a>`;
}
