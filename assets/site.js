...
const homeVendorSearch = document.querySelector("[data-home-vendor-search]");

if (homeVendorSearch) {
  const input = homeVendorSearch.querySelector("[data-home-vendor-search-input]");
  const routes = [
    { url: "/vendors/tokenization-platforms", terms: ["tokenization", "tokenization platforms", "rwa tokenization", "real world assets", "rwa"] },
    { url: "/vendors/legal-regulatory-vendors", terms: ["legal", "regulatory", "legal regulatory", "law firms", "cross border compliance"] },
    { url: "/vendors/kyc-aml-providers", terms: ["kyc", "aml", "kyc aml", "identity verification", "sanctions screening"] },
    { url: "/vendors/smart-contract-development-companies", terms: ["smart contracts", "smart contract development", "onchain development"] },
    { url: "/vendors/ai-infrastructure-providers", terms: ["ai", "ai infrastructure", "analytics", "automation"] },
    { url: "/vendors/crypto-custody-providers", terms: ["custody", "crypto custody", "wallets", "wallet infrastructure", "digital asset custody"] },
    { url: "/vendors/fiat-on-off-ramp-providers", terms: ["fiat", "ramps", "on ramp", "off ramp", "fiat on off ramps"] },
    { url: "/vendors/compliance-infrastructure-providers", terms: ["compliance", "compliance infrastructure", "monitoring", "reporting"] },
    { url: "/vendors/defi-infrastructure-providers", terms: ["defi", "defi infrastructure", "liquidity", "protocols"] },
    { url: "/vendors/stablecoin-infrastructure-providers", terms: ["stablecoin", "stablecoins", "payments", "settlement", "treasury"] },
    { url: "/vendors/security-audit-companies", terms: ["security", "audit", "audits", "security audits", "penetration testing"] },
    { url: "/vendors/growth-marketing-companies", terms: ["growth", "marketing", "web3 marketing", "pr", "branding"] },
    { url: "/vendors/identity-solution-providers", terms: ["identity", "identity solutions", "decentralized identity", "credentials"] },
    { url: "/vendors/blockchain-development-companies", terms: ["blockchain", "blockchain development", "engineering", "integrations"] },
    { url: "/fluidrwa/zoniqx", terms: ["zoniqx"] },
    { url: "/fluidrwa/addx", terms: ["addx"] },
    { url: "/fluidrwa/backed-finance", terms: ["backed", "backed finance"] },
    { url: "/fluidrwa/chainalysis", terms: ["chainalysis"] },
    { url: "/fluidrwa/elliptic", terms: ["elliptic"] },
    { url: "/fluidrwa/trm-labs", terms: ["trm", "trm labs"] },
    { url: "/fluidrwa/anchorage-digital", terms: ["anchorage", "anchorage digital"] },
    { url: "/fluidrwa/bitgo", terms: ["bitgo"] },
    { url: "/fluidrwa/bakkt", terms: ["bakkt"] },
    { url: "/fluidrwa/circle-usdc", terms: ["circle", "usdc"] },
    { url: "/fluidrwa/paypal-pyusd", terms: ["paypal", "pyusd", "paypal pyusd"] },
    { url: "/fluidrwa/certik", terms: ["certik"] },
    { url: "/fluidrwa/openzeppelin", terms: ["openzeppelin"] },
    { url: "/fluidrwa/trail-of-bits", terms: ["trail of bits"] },
    { url: "/fluidrwa/alchemy", terms: ["alchemy"] },
    { url: "/fluidrwa/ankr", terms: ["ankr"] },
    { url: "/fluidrwa/avalanche-ava-labs", terms: ["avalanche", "ava labs"] },
    { url: "/fluidrwa/brands-essential", terms: ["brands essential", "brands essential consultancy"] },
    { url: "/fluidrwa/lunar-strategy", terms: ["lunar strategy"] },
    { url: "/fluidrwa/coinbound", terms: ["coinbound"] },
    { url: "/fluidrwa/civic", terms: ["civic"] },
    { url: "/fluidrwa/spruceid", terms: ["spruceid", "spruce id"] },
    { url: "/fluidrwa/privado-id", terms: ["privado", "privado id"] }
  ];
  const normalize = (value) => value.toLowerCase().replace(/[^a-z0-9]+/g, " ").trim();

  homeVendorSearch.addEventListener("submit", (event) => {
    ...
    const exactMatch = routes.find((route) => route.terms.some((term) => normalize(term) === query));
    const partialMatch = routes.find((route) => route.terms.some((term) => {
      const normalizedTerm = normalize(term);
      return normalizedTerm.includes(query) || query.includes(normalizedTerm);
    }));

    window.location.href = (exactMatch || partialMatch)?.url || `/web3vendorecosystem?search=${encodeURIComponent(rawQuery)}`;
  });
}
